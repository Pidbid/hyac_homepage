document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            nav_docs: "Docs",
            hero_title: "Lightweight Python <span class='highlight'>Cloud Function</span> + FaaS Platform",
            ...
            feature_db_title: "Unified Database Management",
            feature_db_desc: "Built-in database management to simplify data storage and access.",
            feature_deploy_title: "Quick Deploy",
            feature_deploy_desc: "With Docker Compose, you can easily and quickly deploy and manage the entire Hyac platform with a single click.",
        ...
        zh: {
            nav_features: "主要功能",
            nav_docs: "文档",
            hero_title: "轻量级Python <span class='highlight'>云函数</span> + FaaS 平台",
            ...
            feature_db_title: "统一数据库管理",
            feature_db_desc: "内置数据库管理功能，简化数据的存储和访问。",
            feature_deploy_title: "快速部署",
            feature_deploy_desc: "通过 Docker Compose，您可以轻松快速地一键部署和管理整个 Hyac 平台。",
